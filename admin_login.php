...
<link rel="stylesheet" type="text/css" href="fonts/font-awesome/css/font-awesome.css">
	<title>Pels-Home Admin Login</title>
</head>
	...
	<div class="container" id="login_container">
		<div class="row">
			...
			<div class="col-lg-4 offset-lg-4 col-md-7 offset-md-2 col-sm-7 offset-sm-2 col-xs-12">
				...
				<a href="#"><button class="btn btn-primary" id="home" style="border: 2px #fff solid;">Admin <i class="fa fa-home"></i></button> </a>
				</div>
			...
			<div class="col-lg-4 offset-lg-4 col-md-7 offset-md-2 col-sm-7 offset-sm-2 col-xs-12">
					...
					<form method="post" action="" enctype="multipart/form-data" class="form-input" id="form-login">
						<span id="form-title"><center><i>Administrator Login</i></center></span>
											<br>
											<br>
									<center>		
								<div class="form-input">
									<input type="username" name="username" placeholder="Enter your Username" required="" class="form-control" style="width: 200px; margin-bottom: 10px;  padding-left: 30px; margin-right: 50px;" >
								</div>
								...
								<div class="btn-login">
								<button id="submit" class="btn btn-primary"  type="submit" style="margin-left: 100px;" name="admin_login">Login <i class="fa fa-arrow-right"></i></button>
								</div>
								<br>
								<br>
